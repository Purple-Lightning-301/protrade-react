...
function Popup(props) {
  return (
    <div className="modal-container grid">
      <div className="top-month flex">
        <img
        ...
        <div className="top-box flex">
          <div className="top-box-header">
            <span className="top-box-title" style={{ paddingLeft: "25px" }}>
              CAO THỦ PHÁI SINH
            </span>
            <span className="top-box-unit">Đơn vị: VND</span>
          </div>
          <div className="top-item">
            ...
            <span className="username">Lulululu</span>
            <span className="number">1000</span>
          </div>
          <div className="top-item">
            <span className="icon second-icon">
              <img
      ...
      <div className="top-week flex">
        <div className="title">BẢNG XẾP HẠNG TUẦN</div>
        <div className="notice">(Từ 8h00 thứ 2 đến 15H00 thứ 6 hàng tuần)</div>
        <div className="top-box1">
          <div className="top-box-header-week">
            <span className="top-box-title" style={{ paddingLeft: "25px" }}>
              CAO THỦ PHÁI SINH
            </span>
            <span className="top-box-unit">Đơn vị: VND</span>
      ...
      <button onClick={() => props.setOpenModal(false)} className="close-button">x</button>
    </div>
  );
}
